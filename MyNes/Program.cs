...
namespace MyNes
{
	static class Program
	{
		...
		static void Main(string[] Args)
		{
			...
			Program.Emulator = new Emulator(TVSystem.NTSC);
		...
		private static void DoCommandLines(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				{
					case "/audio_on":
						Program.Settings.Audio_SoundEnabled = true;
						FormMain.InitializeSoundRenderer();
						break;
					case "/audio_off":
						Program.Settings.Audio_SoundEnabled = false;
						FormMain.InitializeSoundRenderer();
						break;
					case "/f_skip_off":
					...
					case "/pal_use_gen":
						...
						break;
					case "/pal_dontuse_gen":
						Program.Settings.Palette_UseGenerators = false;
						break;
					case "/pal_gen_auto":
					...
					case "/pal_gen_pal":
						...
						break;
					case "/sram_save_on":
						Program.Settings.SaveSramOnShutdown = true;
						break;
					case "/sram_save_off":
						Program.Settings.SaveSramOnShutdown = false;
						break;
					case "/show_issues_on":
						Program.Settings.ShowRomIssuesIfHave = true;
						break;
					case "/show_issues_off":
						Program.Settings.ShowRomIssuesIfHave = true;
						break;
					case "/tv_auto":
						Program.Settings.TVSystemSetting = Core.TVSystemSetting.AUTO;
						break;
					case "/tv_ntsc":
						Program.Settings.TVSystemSetting = Core.TVSystemSetting.NTSC;
						break;
					case "/tv_pal":
						Program.Settings.TVSystemSetting = Core.TVSystemSetting.PALB;
						break;
					case "/tv_dendy":
						Program.Settings.TVSystemSetting = Core.TVSystemSetting.DENDY;
						break;
					case "/vid_hide_lines_on":
						Program.Settings.Video_CutLines = true;
						break;
					case "/vid_hide_lines_off":
						Program.Settings.Video_CutLines = false;
						break;
					case "/vid_filter_point":
						Program.Settings.Video_Filter = SlimDX.Direct3D9.TextureFilter.Point;
						break;
					case "/vid_filter_none":
						Program.Settings.Video_Filter = SlimDX.Direct3D9.TextureFilter.None;
						break;
					case "/vid_filter_linear":
						Program.Settings.Video_Filter = SlimDX.Direct3D9.TextureFilter.Linear;
						break;
					case "/vid_vertex_hardware":
						Program.Settings.Video_HardwareVertexProcessing = true;
						break;
					case "/vid_vertex_software":
						Program.Settings.Video_HardwareVertexProcessing = false;
						break;
					case "/vid_keep_apsect_on":
						Program.Settings.Video_KeepAspectRatio = true;
						break;
					case "/vid_keep_apsect_off":
						Program.Settings.Video_KeepAspectRatio = false;
						break;
					case "/vid_fps_on":
						Program.Settings.Video_ShowFPS = true;
						break;
					case "/vid_fps_off":
						Program.Settings.Video_ShowFPS = false;
						break;
					case "/vid_noti_on":
						Program.Settings.Video_ShowNotifications = true;
						break;
					case "/vid_noti_off":
						Program.Settings.Video_ShowNotifications = false;
						break;
					case "/vid_fullscreen":
						Program.Settings.Video_StartFullscreen = true;
						break;
					case "/vid_wind":
						Program.Settings.Video_StartFullscreen = false;
						break;
					case "/vid_stretch_wind_on":
						Program.Settings.Video_StretchToMulti = true;
						break;
					case "/vid_stretch_wind_off":
						Program.Settings.Video_StretchToMulti = false;
						break;
					case "/state_slot_0":
						Program.Emulator.emulationState.STATESlot = 0;
						break;
					case "/state_slot_1":
						Program.Emulator.emulationState.STATESlot = 1;
						break;
					case "/state_slot_2":
						Program.Emulator.emulationState.STATESlot = 2;
						break;
					case "/state_slot_3":
						Program.Emulator.emulationState.STATESlot = 3;
						break;
					case "/state_slot_4":
						Program.Emulator.emulationState.STATESlot = 4;
						break;
					case "/state_slot_5":
						Program.Emulator.emulationState.STATESlot = 5;
						break;
					case "/state_slot_6":
						Program.Emulator.emulationState.STATESlot = 6;
						break;
					case "/state_slot_7":
						Program.Emulator.emulationState.STATESlot = 7;
						break;
					case "/state_slot_8":
						Program.Emulator.emulationState.STATESlot = 8;
						break;
					case "/state_slot_9":
						Program.Emulator.emulationState.STATESlot = 9;
						break;
					case "/state_load":
						Program.Emulator.emulationState.LoadState();
						break;// Request a state load on the first rendered frame !
				}
			}

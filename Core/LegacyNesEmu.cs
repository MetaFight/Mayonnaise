...
{
	public class LegacyNesEmu
	{
		/*TODO: fix these palettes*/
		private static readonly int[] VS1 =
		{
		...
		private static readonly int[] VS2 =
		{	
		...
		private static readonly int[] VS3 =
		{	
		...
		private static readonly int[] VS4 =
		{	
		...
		private static readonly int[] VS5 =
		{	
		...
		private static readonly int[] VS6 =
		{	
		...
		private static readonly int[] VS7 =
		{
		...
		public LegacyNesEmu(Ppu ppu)
		{
			this.ppu = ppu;
		}

		public void CheckGameVSUnisystem(string sha1, bool trueByHeader, int mapperNumber)
		{

...
namespace MyNes.Core
{
    ...
    class Mapper115 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                base.Switch02KCHR((chr_reg[0] >> 1) | chr_block, 0x0000, chr_01K_rom_count > 0);
                base.Switch02KCHR((chr_reg[1] >> 1) | chr_block, 0x0800, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[2] | chr_block, 0x1000, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[3] | chr_block, 0x1400, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[4] | chr_block, 0x1800, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[5] | chr_block, 0x1C00, chr_01K_rom_count > 0);
            }
            else
            {
                base.Switch02KCHR((chr_reg[0] >> 1) | chr_block, 0x1000, chr_01K_rom_count > 0);
                base.Switch02KCHR((chr_reg[1] >> 1) | chr_block, 0x1800, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[2] | chr_block, 0x0000, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[3] | chr_block, 0x0400, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[4] | chr_block, 0x0800, chr_01K_rom_count > 0);
                base.Switch01KCHR(chr_reg[5] | chr_block, 0x0C00, chr_01K_rom_count > 0);
            }
        }

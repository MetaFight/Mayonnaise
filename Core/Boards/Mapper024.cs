    ...
    class Mapper024 : Board
    {
            ...
            for (int sq1 = 0; sq1 < 16; sq1++)
            {
                ...
                for (int sq2 = 0; sq2 < 16; sq2++)
                {
                    ...
                    for (int saw = 0; saw < 256; saw++)
                    {
                        ...
                        mix_table[sq1][sq2][saw] = (sqr + tnd) * 128;// TODO: make a real mix for VRC6 sound
                    }
                }
            }
        }
        ...
        public override void WritePRG(ref int address, ref byte data)
        {
            switch (address)
            {
                ...
                case 0xF002: Interrupts.IRQFlags &= ~Interrupts.IRQ_BOARD; irq_enable = irq_enable_on_ak; break;
            }
        }

...
namespace MyNes.Core
{
    ...
    class Mapper194 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                base.Switch02KCHR(chr_reg[0] > 1 ? (chr_reg[0] - 1) >> 1 : chr_reg[0] >> 1, 0x0000, chr_reg[0] > 1);
                base.Switch02KCHR(chr_reg[1] > 1 ? (chr_reg[1] - 1) >> 1 : chr_reg[1] >> 1, 0x0800, chr_reg[1] > 1);
                base.Switch01KCHR(chr_reg[2] > 1 ? (chr_reg[2] - 1) : chr_reg[2], 0x1000, chr_reg[2] > 1);
                base.Switch01KCHR(chr_reg[3] > 1 ? (chr_reg[3] - 1) : chr_reg[3], 0x1400, chr_reg[3] > 1);
                base.Switch01KCHR(chr_reg[4] > 1 ? (chr_reg[4] - 1) : chr_reg[4], 0x1800, chr_reg[4] > 1);
                base.Switch01KCHR(chr_reg[5] > 1 ? (chr_reg[5] - 1) : chr_reg[5], 0x1C00, chr_reg[5] > 1);
            }
            else
            {
                base.Switch02KCHR(chr_reg[0] >> 1, 0x1000, chr_reg[0] > 1);
                base.Switch02KCHR(chr_reg[1] >> 1, 0x1800, chr_reg[1] > 1);
                base.Switch01KCHR(chr_reg[2] > 1 ? (chr_reg[2] - 1) : chr_reg[2], 0x0000, chr_reg[2] > 1);
                base.Switch01KCHR(chr_reg[3] > 1 ? (chr_reg[3] - 1) : chr_reg[3], 0x0400, chr_reg[3] > 1);
                base.Switch01KCHR(chr_reg[4] > 1 ? (chr_reg[4] - 1) : chr_reg[4], 0x0800, chr_reg[4] > 1);
                base.Switch01KCHR(chr_reg[5] > 1 ? (chr_reg[5] - 1) : chr_reg[5], 0x0C00, chr_reg[5] > 1);
            }
        }

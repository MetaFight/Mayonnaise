    ...
    class Mapper025 : Board
    {
        ...
        public override void WritePRG(ref int address, ref byte data)
        {
            switch (address)
            {
                ...
                case 0xB002:
                case 0xB008: chr_Reg[0] = (chr_Reg[0] & 0x0F) | ((data & 0xF) << 4); Switch01KCHR(chr_Reg[0], 0x0000, chr_01K_rom_count > 0); break;

                case 0xB001:
                case 0xB004: chr_Reg[1] = (chr_Reg[1] & 0xF0) | (data & 0xF);/*****/ Switch01KCHR(chr_Reg[1], 0x0400, chr_01K_rom_count > 0); break;
                ...
                case 0xC002:
                case 0xC008: chr_Reg[2] = (chr_Reg[2] & 0x0F) | ((data & 0xF) << 4); Switch01KCHR(chr_Reg[2], 0x0800, chr_01K_rom_count > 0); break;

                case 0xC001:
                case 0xC004: chr_Reg[3] = (chr_Reg[3] & 0xF0) | (data & 0xF);/*****/ Switch01KCHR(chr_Reg[3], 0x0C00, chr_01K_rom_count > 0); break;
                ...
                case 0xD002:
                case 0xD008: chr_Reg[4] = (chr_Reg[4] & 0x0F) | ((data & 0xF) << 4); Switch01KCHR(chr_Reg[4], 0x1000, chr_01K_rom_count > 0); break;

                case 0xD001:
                case 0xD004: chr_Reg[5] = (chr_Reg[5] & 0xF0) | (data & 0xF);/*****/ Switch01KCHR(chr_Reg[5], 0x1400, chr_01K_rom_count > 0); break;
                ...
                case 0xE002:
                case 0xE008: chr_Reg[6] = (chr_Reg[6] & 0x0F) | ((data & 0xF) << 4); Switch01KCHR(chr_Reg[6], 0x1800, chr_01K_rom_count > 0); break;

                case 0xE001:
                case 0xE004: chr_Reg[7] = (chr_Reg[7] & 0xF0) | (data & 0xF);/*****/ Switch01KCHR(chr_Reg[7], 0x1C00, chr_01K_rom_count > 0); break;
                ...
                case 0xF003:
                case 0xF00C: Interrupts.IRQFlags &= ~Interrupts.IRQ_BOARD; irq_enable = irq_enable_on_ak; break;
            }
        }

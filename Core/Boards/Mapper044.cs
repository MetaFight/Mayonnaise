...
namespace MyNes.Core
{
    ...
    [NotImplementedWell("Mapper 44/nSuper Big 7 - in - 1 : Double Dragon 3 game not work.")]
    class Mapper044 : Board
    {
        private bool flag_c;
        private bool flag_p;
        ...
        public override void HardReset()
        {
            ...
            flag_c = flag_p = false;
            address_8001 = 0;
            prg_and = 0x0F; prg_or = 0x00; chr_and = 0x7F; chr_or = 0x000;
            prg_reg = new int[4];
            prg_reg[0] = 0;
            prg_reg[1] = 1;
                ...
                case 0xA001:
                    {
                        ...
                        block = data & 0x7;
                        prg_and = (block > 5) ? 0x1F : 0xF;
                        prg_or = (block < 5) ? (block << 4) : 0x60;
                        chr_and = (block > 5) ? 0xFF : 0x7F;
                        chr_or = (block < 5) ? (block << 7) : 0x300;
                        SetupPRG();
                        SetupCHR();
                        break;
                    }

...
namespace MyNes.Core
{
    ...
    class Mapper118 : Board
    {
        ...
        public override byte ReadNMT(ref int address)
        {
            switch ((address >> 10) & 3)
            {
                case 0: return nmt_banks[(chr_reg[flag_c ? 2 : 0] >> 7) & 1][address & 0x3FF];
                case 1: return nmt_banks[(chr_reg[flag_c ? 3 : 0] >> 7) & 1][address & 0x3FF];
                case 2: return nmt_banks[(chr_reg[flag_c ? 4 : 1] >> 7) & 1][address & 0x3FF];
                case 3: return nmt_banks[(chr_reg[flag_c ? 5 : 1] >> 7) & 1][address & 0x3FF];
            }
        ...
        public override void WriteNMT(ref int address, ref byte data)
        {
            switch ((address >> 10) & 3)
            {
                case 0: nmt_banks[(chr_reg[flag_c ? 2 : 0] >> 7) & 1][address & 0x3FF] = data; break;
                case 1: nmt_banks[(chr_reg[flag_c ? 3 : 0] >> 7) & 1][address & 0x3FF] = data; break;
                case 2: nmt_banks[(chr_reg[flag_c ? 4 : 1] >> 7) & 1][address & 0x3FF] = data; break;
                case 3: nmt_banks[(chr_reg[flag_c ? 5 : 1] >> 7) & 1][address & 0x3FF] = data; break;
            }
        }

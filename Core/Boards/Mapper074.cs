...
namespace MyNes.Core
{
    ...
    class Mapper074 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                base.Switch02KCHR(chr_reg[0] >> 1, 0x0000, chr_reg[0] != 0x8 && chr_reg[0] != 0x9);
                base.Switch02KCHR(chr_reg[1] >> 1, 0x0800, chr_reg[1] != 0x8 && chr_reg[1] != 0x9);
                base.Switch01KCHR(chr_reg[2], 0x1000, chr_reg[2] != 0x8 && chr_reg[2] != 0x9);
                base.Switch01KCHR(chr_reg[3], 0x1400, chr_reg[3] != 0x8 && chr_reg[3] != 0x9);
                base.Switch01KCHR(chr_reg[4], 0x1800, chr_reg[4] != 0x8 && chr_reg[4] != 0x9);
                base.Switch01KCHR(chr_reg[5], 0x1C00, chr_reg[5] != 0x8 && chr_reg[5] != 0x9);
            }
            else
            {
                base.Switch02KCHR(chr_reg[0] >> 1, 0x1000, chr_reg[0] != 0x8 && chr_reg[0] != 0x9);
                base.Switch02KCHR(chr_reg[1] >> 1, 0x1800, chr_reg[1] != 0x8 && chr_reg[1] != 0x9);
                base.Switch01KCHR(chr_reg[2], 0x0000, chr_reg[2] != 0x8 && chr_reg[2] != 0x9);
                base.Switch01KCHR(chr_reg[3], 0x0400, chr_reg[3] != 0x8 && chr_reg[3] != 0x9);
                base.Switch01KCHR(chr_reg[4], 0x0800, chr_reg[4] != 0x8 && chr_reg[4] != 0x9);
                base.Switch01KCHR(chr_reg[5], 0x0C00, chr_reg[5] != 0x8 && chr_reg[5] != 0x9);
            }
        }
